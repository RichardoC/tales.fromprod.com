...
Due to some issues with the groupsService.List() (still pending with Google Support) I found a cleaner way to find the groups, by using a lookup.
...
func main() {
	...
	// Finding the group by using the fact that the GroupKeyId 
